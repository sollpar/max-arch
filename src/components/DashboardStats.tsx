  ...
  return (
    <div className="pt-3 border-t border-neutral-100 mt-6" id="dashboard-stats">
      <div className="flex items-center justify-between mb-2 px-0.5">
        <span className="text-[5px] font-mono text-neutral-300 uppercase tracking-[0.2em] font-medium">momentum_matrix</span>
      </div>
        ...
        {distribution.map(d => (
          <div key={d.type} className="flex flex-col gap-1">
            ...
            <div className="flex justify-between items-baseline">
              <span className="text-[5px] font-mono text-neutral-400 lowercase tracking-tighter leading-none">{d.type}</span>
              <span className="text-[7px] font-mono text-black font-semibold leading-none">{d.count}</span>
            </div>
          </div>
        ))}
      </div>
