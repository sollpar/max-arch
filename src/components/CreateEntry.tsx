    ...
    <div className="mb-4" id="create-entry-container">
      {!isExpanded ? (
        <button
          ...
          id="expand-btn"
        >
          <Plus size={7} strokeWidth={1} />
          <span className="text-[7px] font-mono tracking-tight lowercase font-light italic opacity-60 group-hover:opacity-100">add increment</span>
        </button>
      ) : (
        <motion.form
